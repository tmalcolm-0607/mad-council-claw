...
$updateDftPath = "C:\source\consumer-project\sources\dev\CMS\src\Common\DTOs\Requests\UpdateDftRequest.cs"

Write-Host "Restoring files from git..." -ForegroundColor Cyan

# Restore the files
&git -C "C:\source\consumer-project" checkout -- "sources/dev/CMS/src/Common/Constants/PropertyNames.cs"
&git -C "C:\source\consumer-project" checkout -- "sources/dev/CMS/src/Common/DTOs/Requests/UpdateDftRequest.cs"
