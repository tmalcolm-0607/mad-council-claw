...
# Azure DevOps organization and project -- EDIT THESE for your setup
...
# Replace the example mappings below with your own set of reference repos.
$RepoMapping = @{
    # Example: "local-dir-name" = "ado-repo-name"
