...
```
+===========================================================================+
|  Quality gates are NON-NEGOTIABLE. Pipeline must fail on gate failure.    |
|                                                                           |
...
```
+===========================================================================+
|  MINIMUM COVERAGE: 90% for enterprise projects                            |
|                                                                           |
|  Line coverage >= 90%                                                     |
|  Branch coverage >= 85%                                                   |
...
|--------------|---------|------------------|
| Coverage thresholds below 80% | Low quality code ships | Enforce 90% minimum |
...
- [ ] Test gate with 90%+ coverage threshold
