# Generic structural eval runner. Customize per skill.
$ErrorActionPreference = 'Stop'
$Fixtures = Get-ChildItem -Path "$PSScriptRoot/fixtures" -Filter "*.md"
$Failures = 0
foreach ($f in $Fixtures) {
    ...
    Write-Host "OK: $($f.Name) — fixture + expected present"
}
