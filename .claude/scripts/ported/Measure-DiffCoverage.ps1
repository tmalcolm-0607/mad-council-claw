...
.PARAMETER SolutionPath
    Path to .sln file. Auto-discovers a default location if not specified (edit
    the $candidates array below for your project layout).
...
if (-not $SolutionPath) {
    # Edit this list to match your local project paths
    $candidates = @(
        "C:\source\consumer-project\sources\dev\App\src\App.sln",
        "C:\source\consumer-project\src\App.sln"
    )
